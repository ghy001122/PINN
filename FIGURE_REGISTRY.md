...
- Both are solver-generated failure diagnostics. They do not support E0 pass,
  calibrated-device, experimental-validation, or field-recovery wording.
...
- Figures 1-4 and 6 are generated by `scripts/build_manuscript_ready_gamma_sub_figures.py`.
- Figure 5 is generated by `scripts/build_submission_ready_gamma_sub_figures.py` from the 720-case calibrated sequential validation.
- The 2400-case protocol-robustness stress audit is supplementary `failed_but_informative` evidence because its source sets `whether_ready_as_main_figure=false`.
- All figures are synthetic numerical digital-twin evidence, not experimental data.
