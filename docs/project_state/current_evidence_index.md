...
| Phase 1 v8 shape--scale repair | `supported` authorization/preregistration fact only; not yet executed | independent v8 config; raw inherited/pullback grid gates; one selected-depth global scale; common-K and conditional-runtime stop rules; formal count zero |
