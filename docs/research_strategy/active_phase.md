...
| E1F/E1F-R compact anchor | Original E1F is `implementation_contract_invalid` because Eq. S3 and Fig. 2b extraction violate the implementation contract. E1F-R is `failed_but_informative`: literal-S3 DOP853/Radau parity passes, but the clean 12 V setting traces fail; Fig. 2b remains invalid/unassessed and was not scored. No effective-coordinate audit followed. |
...
Freeze the current scientific result set, finish the complete manuscript and
