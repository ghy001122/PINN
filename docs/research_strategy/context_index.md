...
- Literature: use source decision logs, `references/papers/PAPER_REGISTRY.md`, and only the necessary primary sources; external chat-project documents and generated AI reports are leads, not fact or authorization sources.
