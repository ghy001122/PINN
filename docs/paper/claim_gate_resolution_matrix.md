...
| Bounded CPCF pilot | `failed_but_informative` | `outputs/tables/gamma_sub_cpcf_pilot_summary.json` | Gate b passes, but anchor consistency, locked `20%` improvement, and bootstrap-direction gates fail; full expansion stopped. | Stable/optimal cost frontier, monetary cost, or laboratory resource requirement. |
