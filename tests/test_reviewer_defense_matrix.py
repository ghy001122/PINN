...
def test_reviewer_defense_matrix_covers_required_questions() -> None:
    ...
    required = ["black-box", "full hidden fields", "T_sw", "0.1 K", "F-SPS", "external-curve", "quasi-2D", "phase-transition stiffness", "phase-field inverse", "reduced 2D", "low-dimensional", "stiffness-aware", "Seiler-style", "sharp/front"]
