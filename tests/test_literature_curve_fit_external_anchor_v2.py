...
def test_curve_fit_v2_blocked_official_config() -> None:
    # Official repository state currently has no provenance-backed digitized curves.
    run_ingestion(Path("configs/literature_curve_ingestion.yaml"))
    summary = run_curve_fit_v2(Path("configs/literature_curve_fit_external_anchor_v2.yaml"))
